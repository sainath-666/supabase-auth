 ...
 */
export const PlanResourcesRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 0);
/**
 ...
 */
export const CheckResourceSetRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 1);
/**
 * Describes the message cerbos.request.v1.ResourceSet.
 * Use `create(ResourceSetSchema)` to create a new message.
 */
export const ResourceSetSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 2);
/**
 * Describes the message cerbos.request.v1.AttributesMap.
 * Use `create(AttributesMapSchema)` to create a new message.
 */
export const AttributesMapSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 3);
/**
 ...
 */
export const CheckResourceBatchRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 4);
/**
 ...
 */
export const CheckResourceBatchRequest_BatchEntrySchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 4, 0);
/**
 ...
 */
export const CheckResourcesRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 5);
/**
 ...
 */
export const CheckResourcesRequest_ResourceEntrySchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 5, 0);
/**
 * Describes the message cerbos.request.v1.AuxData.
 * Use `create(AuxDataSchema)` to create a new message.
 */
export const AuxDataSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 6);
/**
 * Describes the message cerbos.request.v1.AuxData.JWT.
 * Use `create(AuxData_JWTSchema)` to create a new message.
 */
export const AuxData_JWTSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 6, 0);
/**
 ...
 */
export const AddOrUpdatePolicyRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 7);
/**
 ...
 */
export const ListAuditLogEntriesRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 8);
/**
 ...
 */
export const ListAuditLogEntriesRequest_TimeRangeSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 8, 0);
/**
 * @generated from enum cerbos.request.v1.ListAuditLogEntriesRequest.Kind
 */
export var ListAuditLogEntriesRequest_Kind;
(function (ListAuditLogEntriesRequest_Kind) {
    /**
     * @generated from enum value: KIND_UNSPECIFIED = 0;
     */
    ListAuditLogEntriesRequest_Kind[ListAuditLogEntriesRequest_Kind["UNSPECIFIED"] = 0] = "UNSPECIFIED";
    /**
     * @generated from enum value: KIND_ACCESS = 1;
     */
    ListAuditLogEntriesRequest_Kind[ListAuditLogEntriesRequest_Kind["ACCESS"] = 1] = "ACCESS";
    /**
     * @generated from enum value: KIND_DECISION = 2;
     */
    ListAuditLogEntriesRequest_Kind[ListAuditLogEntriesRequest_Kind["DECISION"] = 2] = "DECISION";
})(ListAuditLogEntriesRequest_Kind || (ListAuditLogEntriesRequest_Kind = {}));
/**
 * Describes the enum cerbos.request.v1.ListAuditLogEntriesRequest.Kind.
 */
export const ListAuditLogEntriesRequest_KindSchema = /*@__PURE__*/ enumDesc(file_cerbos_request_v1_request, 8, 0);
/**
 * Describes the message cerbos.request.v1.ServerInfoRequest.
 * Use `create(ServerInfoRequestSchema)` to create a new message.
 */
export const ServerInfoRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 9);
/**
 * Describes the message cerbos.request.v1.ListPoliciesRequest.
 * Use `create(ListPoliciesRequestSchema)` to create a new message.
 */
export const ListPoliciesRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 10);
/**
 * Describes the message cerbos.request.v1.GetPolicyRequest.
 * Use `create(GetPolicyRequestSchema)` to create a new message.
 */
export const GetPolicyRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 11);
/**
 * Describes the message cerbos.request.v1.DeletePolicyRequest.
 * Use `create(DeletePolicyRequestSchema)` to create a new message.
 */
export const DeletePolicyRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 12);
/**
 ...
 */
export const DisablePolicyRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 13);
/**
 * Describes the message cerbos.request.v1.EnablePolicyRequest.
 * Use `create(EnablePolicyRequestSchema)` to create a new message.
 */
export const EnablePolicyRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 14);
/**
 ...
 */
export const InspectPoliciesRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 15);
/**
 ...
 */
export const PurgeStoreRevisionsRequestSchema = /*@__PURE__*/ messageDesc(file_cerbos_request_v1_request, 21);
