...
export declare const SwaggerSchema: GenMessage<Swagger, {
    jsonType: SwaggerJson;
    validType: SwaggerValid;
}>;
/**
 ...
 * @generated from enum grpc.gateway.protoc_gen_openapiv2.options.HeaderParameter.Type
 */
export type HeaderParameter_TypeJson = "UNKNOWN" | "STRING" | "NUMBER" | "INTEGER" | "BOOLEAN";
/**
 * Describes the enum grpc.gateway.protoc_gen_openapiv2.options.HeaderParameter.Type.
 */
export declare const HeaderParameter_TypeSchema: GenEnum<HeaderParameter_Type, HeaderParameter_TypeJson>;
/**
...
export declare const ContactSchema: GenMessage<Contact, {
    jsonType: ContactJson;
    validType: ContactValid;
}>;
/**
...
export declare const LicenseSchema: GenMessage<License, {
    jsonType: LicenseJson;
    validType: LicenseValid;
}>;
/**
...
export declare const ExternalDocumentationSchema: GenMessage<ExternalDocumentation, {
    jsonType: ExternalDocumentationJson;
 ...
 * @generated from enum grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes
 */
export type JSONSchema_JSONSchemaSimpleTypesJson = "UNKNOWN" | "ARRAY" | "BOOLEAN" | "INTEGER" | "NULL" | "NUMBER" | "OBJECT" | "STRING";
/**
 * Describes the enum grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes.
 */
export declare const JSONSchema_JSONSchemaSimpleTypesSchema: GenEnum<JSONSchema_JSONSchemaSimpleTypes, JSONSchema_JSONSchemaSimpleTypesJson>;
/**
...
export declare const SecurityDefinitionsSchema: GenMessage<SecurityDefinitions, {
    jsonType: SecurityDefinitionsJson;
 ...
 * @generated from enum grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type
 */
export type SecurityScheme_TypeJson = "TYPE_INVALID" | "TYPE_BASIC" | "TYPE_API_KEY" | "TYPE_OAUTH2";
/**
 * Describes the enum grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type.
 */
export declare const SecurityScheme_TypeSchema: GenEnum<SecurityScheme_Type, SecurityScheme_TypeJson>;
/**
 ...
 */
export declare const SecurityScheme_InSchema: GenEnum<SecurityScheme_In, SecurityScheme_InJson>;
/**
 * The flow used by the OAuth2 security scheme. Valid values are
 * "implicit", "password", "application" or "accessCode".
 *
 ...
 * @generated from enum grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow
 */
export type SecurityScheme_FlowJson = "FLOW_INVALID" | "FLOW_IMPLICIT" | "FLOW_PASSWORD" | "FLOW_APPLICATION" | "FLOW_ACCESS_CODE";
/**
 * Describes the enum grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow.
 */
export declare const SecurityScheme_FlowSchema: GenEnum<SecurityScheme_Flow, SecurityScheme_FlowJson>;
/**
...
export declare const SecurityRequirementSchema: GenMessage<SecurityRequirement, {
    jsonType: SecurityRequirementJson;
...
export type SecurityRequirement_SecurityRequirementValueValid = SecurityRequirement_SecurityRequirementValue;
/**
 ...
 */
export declare const SchemeSchema: GenEnum<Scheme, SchemeJson>;
